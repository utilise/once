...
function event(node, index) {
  ...
  node.emit = function(type, detail) {
    node.dispatchEvent(detail instanceof window.Event ? detail
      : new window.CustomEvent(type, { detail: detail, bubbles: false, cancelable: true }))
    return node
  }
